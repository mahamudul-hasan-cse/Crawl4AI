...
openai_api_key = os.getenv("OPENAI_API_KEY")  # Make sure to set the environment variable or replace it directly here
if not openai_api_key:
    openai_api_key = "your-openai-api-key-here"  # Replace with your actual OpenAI API key if not using environment variable

# Create AsyncOpenAI client using the OpenAI API key
client = AsyncOpenAI(
    base_url="https://api.groq.com/openai/v1", api_key=openai_api_key
)
